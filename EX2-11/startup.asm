...
%define wFPU	1
%define HALF_MEM 1		; excludes DRAM that overlaps the ROM
...
; set up UCS for 64K ROM
	winit	UCSADH, 0x000F
	winit	UCSADL, 0x0100 + 3	; MEM, 3 w.s.
